...
<div style="max-width: 900px; margin: 0 auto; padding-bottom: 40px;">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <h2 style="font-size: 18px; font-weight: 700; color: #0f172a;">Novo Produto ou Serviço</h2>
    </div>
    ...
    <form method="POST" action="{{ route('products.store') }}" id="product-form">
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="grid-2 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Ex: Câmera Intelbras 1220B" required>
            ...
            <div class="grid-2 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="sku" id="sku" value="{{ old('sku') }}" class="form-control @error('sku') is-invalid @enderror" placeholder="Ex: CAM-1220B" required>
                    @error('sku') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="form-group" id="barcode-group">
                    <label class="form-label" for="barcode">Código de Barras (EAN)</label>
                    <input type="text" name="barcode" id="barcode" value="{{ old('barcode') }}" class="form-control" placeholder="Opcional">
                </div>
            </div>

            <div class="form-group">
                <label class="form-label" for="description">Descrição Completa</label>
                <textarea name="description" id="description" class="form-control" rows="3" placeholder="Informações públicas/comerciais sobre o item...">{{ old('description') }}</textarea>
            </div>
        </div>
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="grid-2 mb-3">
                <div class="form-group" id="cost-price-group">
                    ...
                    <input type="text" name="cost_price" id="cost_price" value="{{ old('cost_price') }}" class="form-control money" placeholder="0,00" required>
                </div>

                <div class="form-group">
                    <label class="form-label" for="sale_price">Preço de Venda (R$) <span style="color:#ef4444">*</span></label>
                    <input type="text" name="sale_price" id="sale_price" value="{{ old('sale_price') }}" class="form-control money" placeholder="0,00" required>
                </div>
            </div>
            ...
            <div id="inventory-section">
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                    <div class="flex items-center gap-2 mb-3">
                        <input type="checkbox" name="is_stock_controlled" id="is_stock_controlled" value="1" {{ old('is_stock_controlled') ? 'checked' : '' }} onchange="toggleStockField(this.checked)">
                    ...
                    <div class="form-group" id="stock-field-group" style="display: {{ old('is_stock_controlled') ? 'block' : 'none' }}; margin-bottom: 0;">
                        <label class="form-label" for="stock">Estoque Inicial</label>
                        <input type="text" name="stock" id="stock" value="{{ old('stock') }}" class="form-control" placeholder="0" style="max-width: 200px;">
        ...
        <div class="card mb-4 shadow-sm" id="fiscal-section" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="form-group mb-3">
                ...
                <select name="fiscal_origin" id="fiscal_origin" class="form-control" required>
                    @foreach($fiscalOrigins as $origin)
                        <option value="{{ $origin->value }}" {{ old('fiscal_origin', 0) == $origin->value ? 'selected' : '' }}>{{ $origin->label() }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="grid-3 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="ncm" id="ncm" value="{{ old('ncm') }}" class="form-control" placeholder="Ex: 85258913">
                </div>

                <div class="form-group">
                    <label class="form-label" for="cfop">CFOP Padrão</label>
                    <input type="text" name="cfop" id="cfop" value="{{ old('cfop') }}" class="form-control" placeholder="Ex: 5102">
                </div>
                ...
                <div class="form-group" id="unit-group-com">
                    ...
                    <input type="text" name="commercial_unit" id="commercial_unit" value="{{ old('commercial_unit', 'UN') }}" class="form-control" placeholder="Ex: UN" required>
                </div>
            </div>
            ...
            <div class="grid-3 mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="cst" id="cst" value="{{ old('cst') }}" class="form-control" placeholder="Ex: 00">
                </div>

                <div class="form-group">
                    <label class="form-label" for="csosn">CSOSN (Simples Nacional)</label>
                    <input type="text" name="csosn" id="csosn" value="{{ old('csosn') }}" class="form-control" placeholder="Ex: 102">
                </div>
                ...
                <div class="form-group" id="unit-group-trib">
                    ...
                    <input type="text" name="taxable_unit" id="taxable_unit" value="{{ old('taxable_unit', 'UN') }}" class="form-control" placeholder="Ex: UN" required>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="internal_notes" id="internal_notes" class="form-control" rows="2" placeholder="Informações de suporte técnico ou restrições internas...">{{ old('internal_notes') }}</textarea>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Inicializar com base no valor atual do tipo
