    ...
    <form method="POST" action="{{ route('quotes.store') }}" id="quote-form">
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="grid-2 mb-3" style="position: relative;">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <div id="client-details-card" style="display: none; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; position: relative;">
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="grid-3 mb-4">
                <div class="form-group">
                    ...
                    <input type="text" name="carrier" id="carrier" class="form-control" placeholder="Ex: Braspress, Correios, Própria..." value="{{ old('carrier') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="freight_type" id="freight_type" class="form-control">
                        <option value="9" {{ old('freight_type', 9) == 9 ? 'selected' : '' }}>Sem Frete / CIF</option>
                        <option value="0" {{ old('freight_type') == 0 ? 'selected' : '' }}>Contratação do Frete por conta do Remetente (CIF)</option>
                        <option value="1" {{ old('freight_type') == 1 ? 'selected' : '' }}>Contratação do Frete por conta do Destinatário (FOB)</option>
                        <option value="2" {{ old('freight_type') == 2 ? 'selected' : '' }}>Contratação do Frete por conta de Terceiros</option>
                        <option value="3" {{ old('freight_type') == 3 ? 'selected' : '' }}>Transporte Próprio por conta do Remetente</option>
                        <option value="4" {{ old('freight_type') == 4 ? 'selected' : '' }}>Transporte Próprio por conta do Destinatário</option>
                    </select>
                </div>

                <div class="form-group">
                    <label class="form-label" for="freight_price">Valor do Frete (R$)</label>
                    <input type="text" name="freight_price" id="freight_price" class="form-control money" placeholder="0,00" value="{{ old('freight_price', '0,00') }}">
                </div>
            </div>
            ...
            <div class="grid-3 mb-4">
                <div class="form-group">
                    ...
                    <input type="number" step="1" name="volume" id="volume" class="form-control" placeholder="Ex: 1, 5..." value="{{ old('volume') }}">
                </div>

                <div class="form-group">
                    <label class="form-label" for="weight_gross">Peso Bruto (kg)</label>
                    <input type="text" name="weight_gross" id="weight_gross" class="form-control decimal" placeholder="0,00" value="{{ old('weight_gross') }}">
                </div>

                <div class="form-group">
                    <label class="form-label" for="weight_net">Peso Líquido (kg)</label>
                    <input type="text" name="weight_net" id="weight_net" class="form-control decimal" placeholder="0,00" value="{{ old('weight_net') }}">
                </div>
            </div>
            ...
            <div class="grid-3">
                <div class="form-group">
                    ...
                    <input type="text" name="delivery_deadline" id="delivery_deadline" class="form-control" placeholder="Ex: 5 dias úteis, Imediato..." value="{{ old('delivery_deadline') }}">
                </div>

                <div class="form-group">
                    <label class="form-label" for="warranty">Garantia Comercial</label>
                    <input type="text" name="warranty" id="warranty" class="form-control" placeholder="Ex: 12 meses, 90 dias..." value="{{ old('warranty', '12 meses') }}">
                </div>

                <div class="form-group">
                    <label class="form-label" for="validity">Validade da Proposta</label>
                    <input type="text" name="validity" id="validity" class="form-control" placeholder="Ex: 10 dias, 15 dias..." value="{{ old('validity', '15 dias') }}">
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 12px; border: 1px solid #e2e8f0; padding: 24px;">
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="notes" id="notes" class="form-control" rows="3" placeholder="Ex: Condições de pagamento extras, detalhes de instalação..."></textarea>
            </div>
