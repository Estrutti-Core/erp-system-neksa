                    ...
                    <tbody>
                        @forelse($sales as $sale)
                            <tr>
                                ...
                                <td style="font-family: monospace; color: #475569;">R$
                                    {{ number_format($sale->items_amount, 2, ',', '.') }}</td>
                                ...
                                <td style="font-weight: 700; color: #0f172a; font-family: monospace;">R$
                        ...
                        @empty
                            <tr>
                                <td colspan="8" style="text-align: center; padding: 40px 20px; color: #64748b;">
                                    <x-heroicon-o-shopping-bag class="w-10 h-10" style="margin: 0 auto 12px; color: #cbd5e1;" />
                                    <p style="font-weight: 500;">Nenhuma venda encontrada</p>
                                    <p style="font-size: 13px; color: #94a3b8; margin-top: 4px;">Aprovando e convertendo
                                        orçamentos qualificados de tipo Venda, elas aparecerão aqui.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
