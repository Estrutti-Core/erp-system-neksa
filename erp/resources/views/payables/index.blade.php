...
@section('topbar-actions')
    <a href="{{ route('payables.export.xlsx', request()->all()) }}" class="btn btn-success flex items-center gap-2" style="background-color: #16a34a; border-color: #16a34a; color: white;">
...
<div class="card">
    <div class="card-body p-0">
        <form method="GET" action="{{ route('payables.index') }}" id="filter-form">
                ...
                <table class="table mb-0">
                    <thead>
                        ...
                        <tr class="bg-slate-50 border-b border-slate-200">
                            ...
                            <td>
                                <span class="text-xs text-slate-400">Busca no código/fornecedor</span>
                            </td>
                            <td>
                            ...
                            <td style="text-align:right">
                                <div class="flex gap-1 justify-end">
                                    ...
                                    <a href="{{ route('payables.index') }}" class="btn btn-secondary btn-sm" style="padding: 4px 8px;" title="Limpar Filtros">
                    ...
                    <tbody>
                        @forelse($payables as $pay)
                            <tr>
                                ...
                                <td>R$ {{ number_format($pay->total_amount, 2, ',', '.') }}</td>
                                <td>R$ {{ number_format($pay->net_amount, 2, ',', '.') }}</td>
                                <td>
                                    @php
                                ...
                                <td style="text-align:right">
                                    <a href="{{ route('payables.show', $pay) }}" class="btn btn-secondary btn-sm" style="padding: 4px 8px;" title="Ver Detalhes">
