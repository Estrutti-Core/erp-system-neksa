...
<div style="max-width: 900px; margin: 0 auto; padding-bottom: 40px;">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <h2 style="font-size: 18px; font-weight: 700; color: #0f172a;">Novo Pedido de Compra</h2>
    </div>
    ...
    <form method="POST" action="{{ route('purchase-orders.store') }}" id="order-form">
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('purchase-orders.index') }}" class="btn btn-secondary" style="border-radius: 8px;">Cancelar</a>
